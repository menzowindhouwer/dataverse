...
docker run -d -p 8083:8080 -p 8084:80 -v $_PWD/conf/docker-aio/cmd/dv_cmdi_conf.xml:/opt/dv/cmdi_config.xml -e DV_CMDI_CONF=/opt/dv/cmdi_config.xml --name dv dv0
while true; do
	docker logs dv
